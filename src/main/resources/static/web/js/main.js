...
function getLangDate(){
    ...
    document.getElementById("nowTime").innerHTML = "亲爱的" + document.getElementById("userName").value + "，"+timeValue+"好！ 感谢您使用"+ document.getElementById("platformName").value +"。当前时间为： "+newDate+"　"+week;
